...
gem 'insights-api-common', :git => 'https://github.com/mkanoor/manageiq-api-common', :branch => 'debug_messages'
gem 'jbuilder', '~> 2.0'
...
gem 'rbac-api-client', :git => "https://github.com/mkanoor/insights-rbac-api-client-ruby", :branch => "no_api_key"
